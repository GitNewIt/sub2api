export default {
    accounts: {
      ...
      tempUnschedulable: {
        ...
        hint: 'Disable accounts temporarily when the error code or a keyword matches.',
        notice: 'Rules are evaluated in order. Matching the error code or any keyword pauses scheduling. Both fields are optional, but at least one is required.',
        addRule: 'Add Rule',
        ...
        keywordsHint: 'Optional. Separate keywords with commas; any keyword match will trigger.',
        description: 'Description',
        descriptionPlaceholder: 'Optional note for this rule',
        rulesInvalid: 'Add at least one rule with a duration and either an error code or keywords.',
