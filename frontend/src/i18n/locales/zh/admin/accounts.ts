export default {
    accounts: {
      ...
      tempUnschedulable: {
        ...
        hint: '当错误码或关键词任一匹配时，账号会在指定时间内被临时禁用。',
        notice: '规则按顺序匹配，错误码或关键词命中其一即可；两者都可留空，但至少填一项。',
        addRule: '添加规则',
        ruleOrder: '规则序号',
        ...
        keywordsHint: '可选。多个关键词用逗号分隔，匹配时命中其中之一即可。',
        description: '描述',
        descriptionPlaceholder: '可选，便于记忆规则用途',
        rulesInvalid: '请至少填写一条包含时长，且错误码或关键词至少一项的规则。',
